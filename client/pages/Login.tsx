  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col items-center justify-start pt-12 px-6">
      ...
      <button
        ...
        disabled={loading}
        className="w-full max-w-sm h-12 bg-white border-2 border-gray-300 text-gray-700 text-base font-semibold rounded-2xl hover:bg-gray-50 transition disabled:opacity-70 flex items-center justify-center gap-3 mb-8"
      >
      ...
      <button
        ...
        className="text-terrakeeper-light-green text-sm font-medium hover:underline"
      >
        Create an account
      </button>
    </div>
